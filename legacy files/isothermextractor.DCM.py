...
#    print(z)
    drx = str("./{0:02d}/isotherm.DCM" .format(page)) # defines the isotherm
#    print(drx)
    f = open(drx, "r")
    x = []
...
for i in range (1,17): #loops over your 16 isotherms
    ...
    for file in filenames:
        if file == "isotherm.DCM": #change the np.zeroes to be your results
            isothermextract(i)
            SuccessCount += 1
...
np.savetxt("../IRMOF1.298.DCM.mix20.csv", avgisotherms, delimiter=",") #output it to this file
