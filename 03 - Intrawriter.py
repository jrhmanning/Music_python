...
logger.debug('-----------------------------------')
##################
####This section sorts out your list of species' and frameworks to amke an intramolecular file for you
species = ['XXXX']
framework = 'YYYY'
sorb_el_list = ['''### your element list here###''']
targetdirectory='./experiments/{0}/298/'.format(species)
##################
setup.IntraWriter(logger, species, sorb_el_list, framework, targetdirectory)
