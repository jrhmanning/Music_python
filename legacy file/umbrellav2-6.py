...
for i in el_list:
    sorb_el_list.append("{0}_sorb" .format(i.split("_")[0])) #Sometimes I'll call them X_something esle to denote their forcefield for instance. This hould cut it back to just X
