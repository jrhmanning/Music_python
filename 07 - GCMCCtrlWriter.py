...
##################
setup.GcmcControlChanger(logger, species[-1], sorb_el_list, T, n, framework, tagretdir, '1000000', 'RESTARTFILE {0}.{1}.res.{2}'.format(framework, species[-1], 20)) #for production runs
